...
const plans: PlanDef[] = [
  {
    ...
    badge: null,
    popular: false,
    features: ["10 Mock Tests", "100 Credits", "AI-Powered Analysis", "Detailed Score Reports", "Grammar Correction"],
  },
  {
    name: "Pro",
    ...
    badge: "Best Value",
    popular: true,
    features: ["20 Mock Tests", "200 Credits", "AI-Powered Analysis", "Detailed Score Reports", "Grammar Correction", "Red Flag Detection", "Improvement Plans"],
  },
  {
    name: "Premium",
    ...
    badge: "Popular",
    popular: false,
    features: ["40 Mock Tests", "400 Credits", "AI-Powered Analysis", "Detailed Score Reports", "Grammar Correction", "Red Flag Detection", "Improvement Plans", "Priority Support"],
  },
];
          ...
          return (
            ...
            >
              ...
              <div className="mb-1">
                ...
                <span className="text-4xl font-extrabold tracking-tight">{currencySymbol}{formatPrice(finalPrice)}</span>
              </div>
